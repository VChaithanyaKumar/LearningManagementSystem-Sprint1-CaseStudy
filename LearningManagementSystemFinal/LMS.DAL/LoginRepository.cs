...
namespace LMS.DAL
{
    public class LoginRepository: ILoginRepository
    {
        ...
        //lConnection connection = new SqlConnection(@"Data Source=LAPTOP-P4UMIEHT\SQLEXPRESS;Initial Catalog=LearningManagementSystem;Integrated Security=True");
        ...
        //Get Login Details-->UserType,UserEmail,Password-----Praveena
