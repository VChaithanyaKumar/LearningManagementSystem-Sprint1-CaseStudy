    ...
    class Program
    {
        static void Main(string[] args)
        {
         ...
         MainMenu:  Console.WriteLine("1. Existing User");
                                    ...
                                    case 1:
                                        {
                                            ...
                                            user = new User();
                                            user.UserType = "Admin";
                AdminReEnter:              Console.WriteLine("Enter Login Details of an Admin:");
                                            Console.WriteLine("-------------------------------------");
                ...
                OldPasswordRetype:                          Console.Write("Enter Old PassWord: ");
                                                            string OldPassword = Console.ReadLine();
                                                            if(string.Equals(OldPassword,adminServices.GetPassword(Email)))
                                                            {
                                                            ...
                                                            {
                                                                Console.WriteLine("Entered Old Password is wrong");
                                                                goto OldPasswordRetype;
                                                            }
                                                            break;
                                                        case 3:
                                                            //delete User
