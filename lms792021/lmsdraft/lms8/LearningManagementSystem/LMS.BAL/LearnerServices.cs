    ...
    public class LearnerServices
    {
        ...
        public void SubmitTest(List<string> Answers,string CourseTitle,string UserEmail)
        {
            try
            {
                ...
                Console.WriteLine();
                Console.WriteLine("To get more details Check out Certificate Option");
                Console.WriteLine();
                Console.WriteLine("Pass Percentage should be greater than 60");
                Console.WriteLine();
        ...
        public void ViewSubmissionCertificate(User user,string CourseTitle)
        {
            ...
            try
            {
                ...
                courseEnroll.DateOfCompletion = (DateTime)learnerRepository.GetSubmitDate(user, CourseTitle);*/
                if (result.ResultDescription > 60)
                {
                    Console.WriteLine("_________________________________________________________________");
                    Console.WriteLine("             Course Completion Certificate               ");
                    Console.WriteLine("_________________________________________________________________");
                    Console.WriteLine("Mr/Ms " + user.UserFirstName + " " + user.UserLastName + " Completed the Course '" + CourseTitle +/* "on" + courseEnroll.DateOfCompletion +*/ "' Successfully!");
