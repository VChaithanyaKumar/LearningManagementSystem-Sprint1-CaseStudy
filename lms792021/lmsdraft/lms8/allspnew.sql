...
create procedure GetSubmitDate(@UserEmail varchar(20),@CourseTitle varchar(30))
as
declare @UserId numeric(10),@CourseId numeric(10)
select @UserId=UserId from [User] where UserEmail=@UserEmail
select @CourseId=CourseId from Course where CourseTitle=@CourseTitle
begin
select DateOfCompletion from CourseEnroll where UserId=@UserId and CourseId=@CourseId

end
exec GetSubmitDate 'sk@gmail.com','Learn C#'
delete from CourseEnroll where UserId=109
