...
namespace LMS.DAL
{
    public class AdminRepository: IAdminRepository
    {
        ...
        public void RemoveResult(string UserEmail)
        {
            try
            {
                command = new SqlCommand("RemoveResult", connection)
                {
                    CommandType = CommandType.StoredProcedure
                };
                command.Parameters.AddWithValue("@UserEmail", UserEmail);
        ...
        public void RemoveResultcourse(string CourseTitle)
        {
            try
            {
                command = new SqlCommand("RemoveResultcourse", connection)
                {
                    CommandType = CommandType.StoredProcedure
                };
                command.Parameters.AddWithValue("@CourseTitle", CourseTitle);
